        ...
        if self.objects:
            ...
            if "GLUE2Domain" in self.objects and "GLUE2Location" not in self.objects:
                message = message + validator.utils.message_generator(
                    ...
                    "E025",
                    "NA",
                    "GLUE2Domain published",
                    "GLUE2Location missing",
                )
                status = False
            ...
            if (
                ...
                message = message + validator.utils.message_generator(
                    ...
                    "E025",
                    "NA",
                    "GLUE2ComputingService published",
                    "GLUE2Service missing",
                )
                status = False
            if (
            ...
            if (
                ...
                message = message + validator.utils.message_generator(
                    ...
                    "E025",
                    "NA",
                    "GLUE2ComputingEndpoint published",
                    "GLUE2Endpoint missing",
                )
                status = False
            if (
                ...
                message = message + validator.utils.message_generator(
                    ...
                    "E025",
                    "NA",
                    "GLUE2StorageEndpoint published",
                    "GLUE2Endpoint missing",
                )
                status = False
            if (
            ...
            if (
                ...
                message = message + validator.utils.message_generator(
                    ...
                    "E025",
                    "NA",
                    "GLUE2Share published",
                    "GLUE2MappingPolicy missing",
                )
                status = False
            if (
                ...
                message = message + validator.utils.message_generator(
                    ...
                    "E025",
                    "NA",
                    "GLUE2Endpoint published",
                    "GLUE2AccessPolicy missing",
                )
                status = False
            if (
                "GLUE2ComputingService" in self.objects
            ...
            if (
                ...
                message = message + validator.utils.message_generator(
                    ...
                    "E025",
                    "NA",
                    "GLUE2ComputingManager published",
            ...
            if (
                ...
                message = message + validator.utils.message_generator(
                    ...
                    "E025",
                    "NA",
                    "GLUE2StorageShareCapacity published",
                    "GLUE2StorageShare missing",
                )
                status = False
            if (
                "GLUE2StorageService" in self.objects
                ...
                message = message + validator.utils.message_generator(
                    ...
                    "NA",
                    "GLUE2StorageService published",
                    "GLUE2StorageAccessProtocol missing",
                )
                status = False
